...
class RegistrationForm(forms.Form):
    ...
    toscheck  = forms.BooleanField(label=_(u'I have read and agree with the terms of service'))
    ...
    def clean(self):
        ...
        if 'password1' in self.cleaned_data and 'password2' in self.cleaned_data:
            if self.cleaned_data['email']:
                raise forms.ValidationError(_(u'Go die in hell you god damn motherfucking bot!!!!'))
            if not self.cleaned_data['toscheck']:
                raise forms.ValidationError(_(u'You must agree with the terms of service'))
            ...
            try:
                ...
                raise forms.ValidationError(_(u'You must type your email twice'))
